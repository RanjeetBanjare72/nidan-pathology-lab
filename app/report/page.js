...
export default function ReportPage() {
  ...
  /* =====================================================
     ...
     NOTE:
     These are software defaults only.
     Laboratory-specific validated ranges should take
     priority when supplied in the test configuration.
  ===================================================== */
