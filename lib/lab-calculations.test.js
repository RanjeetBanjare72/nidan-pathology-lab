...
describe("NIDAN calculation engine", () => {
  ...
  it("ignores blank and non-numeric inputs instead of producing NaN", () => {
    const r = calculateDerivedResults({ Haemoglobin: "", "RBC Count": "abc", "Total Cholesterol": "200", "HDL Cholesterol": "50" });
    expect(r.MCH).toBeUndefined();
    expect(r["Non-HDL Cholesterol"].value).toBe(150);
  });
});
